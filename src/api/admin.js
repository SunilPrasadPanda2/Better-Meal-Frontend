...
export const getMealAllQuestions = async () => {
  ...
  const token = JSON.parse(authData.auth).token;
  try {
    const response = await api.get("/user/get-meal-questions", {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const addMealQuestion = async (data) => {
  ...
  const token = JSON.parse(authData.auth).token;
  try {
    const response = await api.post("admin/add-meal-preference", data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const addFaq = async (data) => {
  ...
  const token = JSON.parse(authData.auth).token;
  try {
    const response = await api.post("/admin/add-faq", data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const addGutSurveyQuestion = async (data) => {
  ...
  const token = JSON.parse(authData.auth).token;
  try {
    const response = await api.post("/admin/add-gut-survey-questions", data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
